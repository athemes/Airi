...
class Atu_Social extends WP_Widget {

    function __construct() {
        $widget_ops = array( 'description' => __('Display your social profile', 'atu') );
        parent::__construct( 'athemes_social_widget', __('Atu: Social Profile', 'atu'), $widget_ops );
    }
