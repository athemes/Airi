...
class aThemes_Portfolio extends Widget_Base {
	...
	public function get_title() {
		return __( 'aThemes: Portfolio', 'airi' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'portfolio_list',
			[
				'label' => __( 'Feairires list', 'airi' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'name' 			=> __( 'John Doe', 'airi' ),
						'position' 		=> __( 'Manager', 'airi' ),
						'testimonial' 	=> __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id purus neque. Curabitur pulvinar elementum neque in dictum. Sed non lectus nec tortor iaculis tincidunt.', 'airi' ),				
					],
					[
						'name' 			=> __( 'James Stevens', 'airi' ),
						'position' 		=> __( 'Manager', 'airi' ),
						'testimonial' 	=> __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id purus neque. Curabitur pulvinar elementum neque in dictum. Sed non lectus nec tortor iaculis tincidunt.', 'airi' ),
					],
				],
				'fields' => [
					...
					[
						...
						'label_block' => true,
						'placeholder' => __( 'Title', 'airi' ),
						'default' => __( 'Project title', 'airi' ),
					],
					[
						'name' => 'term',
						'label' => __( 'Filter term', 'airi' ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
						'placeholder' => __( 'Term for the filter', 'airi' ),
						'default' => __( 'Art', 'airi' ),
					],
					[
						'name' => 'link',
						...
						'label_block' => true,
						'placeholder' => __( 'Link for this project', 'airi' ),
						'default' => '',
					],
		...
		$this->add_control(
			'show_all_text',
			[
				'label' => __( 'Text for show all button', 'airi' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Show all', 'airi' ),
				'placeholder' => __( 'Text for show all button', 'airi' ),
			]
		);	
	...
	protected function render() {
		...
		<div class="athemes-project-wrap portfolio-section style1">
			...
			<div class="roll-project fullwidth loading">
				...
				<div class="loading-notice"><?php echo esc_html__( 'Loading...', 'airi' ); ?></div>
						...
						<div class="project-inner">
							...
							<div class="project-info">
								<h3 class="project-title">
									<a <?php echo $this->get_render_attribute_string( 'button-' . $c ); ?>><?php echo esc_html( $item['title'] ); ?></a>
								</h3>
							</div>
							<a href="#">
